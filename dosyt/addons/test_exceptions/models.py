...
class m(models.Model):
    ...
    def generate_redirect_warning(self):
        ...
        raise dosyt.exceptions.RedirectWarning('description', action.id, 'Go to the redirection')

    def generate_access_denied(self):
        raise dosyt.exceptions.AccessDenied()

    def generate_access_error(self):
        raise dosyt.exceptions.AccessError('description')
    ...
    def generate_user_error(self):
        raise dosyt.exceptions.UserError('description')

    def generate_missing_error(self):
        raise dosyt.exceptions.MissingError('description')

    def generate_validation_error(self):
        raise dosyt.exceptions.ValidationError('description')
