...
from dosyt.addons.base.tests.common import HttpCaseWithUserDemo
...
@dosyt.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(dosyt.tests.HttpCase):

    @mute_logger('dosyt.sql_db', 'dosyt.http')
