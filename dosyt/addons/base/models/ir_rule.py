...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - dosyt/addons/test_access_rights/tests/test_feedback.py
        # - dosyt/addons/test_access_rights/tests/test_ir_rules.py
        # - dosyt/addons/base/tests/test_orm.py (/home/dle/src/dosyt/master-nochange-fp/dosyt/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res
