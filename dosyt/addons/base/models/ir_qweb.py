...
from dosyt import api, models, tools
from dosyt.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
from dosyt.tools.misc import get_lang
from dosyt.http import request
from dosyt.modules.module import get_resource_path

from dosyt.addons.base.models.qweb import QWeb, Contextifier
from dosyt.addons.base.models.assetsbundle import AssetsBundle
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from dosyt.addons.web.controllers.main import module_boot
