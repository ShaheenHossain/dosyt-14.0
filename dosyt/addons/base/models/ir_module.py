...
import dosyt
from dosyt import api, fields, models, modules, tools, _
from dosyt.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from dosyt.exceptions import AccessDenied, UserError
from dosyt.osv import expression
from dosyt.tools.parse_version import parse_version
from dosyt.tools.misc import topological_sort
...
class Module(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Dosyt Enterprise Edition License v1.0'),
        ('OPL-1', 'Dosyt Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Dosyt Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Dosyt is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(dosyt.conf.server_wide_modules) & set(self.mapped('name'))
    ...
    def install_from_urls(self, urls):
        ...
        OPENERP = dosyt.release.product_name.lower()
        ...
        try:
            ...
            if urls.get(OPENERP):
                ...
                # copy all modules in the SERVER/dosyt/addons directory to the new "dosyt" module (except base itself)
                for d in os.listdir(base_path):
                    if d != 'base' and os.path.isdir(os.path.join(base_path, d)):
                        destdir = os.path.join(tmp, OPENERP, 'addons', d)    # XXX 'dosyt' subdirectory ?
                ...
                _logger.info('Copy downloaded module `dosyt` to `%s`', server_dir)
    ...
    def get_apps_server(self):
        return tools.config.get('apps_server', 'https://apps.dosyt.com/apps')
