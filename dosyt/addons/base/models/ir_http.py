...
import dosyt
from dosyt import api, http, models, tools, SUPERUSER_ID
from dosyt.exceptions import AccessDenied, AccessError, MissingError
from dosyt.http import request, content_disposition
from dosyt.tools import consteq, pycompat
from dosyt.tools.mimetypes import get_extension, guess_mimetype
from dosyt.modules.module import get_resource_path, get_module_path

from dosyt.http import ALLOWED_DEBUG_MODES
from dosyt.tools.misc import str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(dosyt.conf.server_wide_modules)
            if tools.config['test_enable'] and dosyt.modules.module.current_test:
                installed.add(dosyt.modules.module.current_test)
