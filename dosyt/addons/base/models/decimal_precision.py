...
from dosyt import api, fields, models, tools
import dosyt.addons
...
dp = sys.modules['dosyt.addons.base.models.decimal_precision']
dosyt.addons.decimal_precision = dp
sys.modules['dosyt.addons.decimal_precision'] = dp
