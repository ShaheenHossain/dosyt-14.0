...
from dosyt.exceptions import AccessError, ValidationError
from dosyt.tests import common
from dosyt.tools import mute_logger, view_validation
from dosyt.addons.base.models.ir_ui_view import (
...
class TestApplyInheritanceSpecs(ViewCase):
    ...
    @mute_logger('dosyt.addons.base.models.ir_ui_view')
...
class TestViews(ViewCase):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view'):
        with self.assertRaises(ValidationError) as catcher, mute_logger('dosyt.addons.base.models.ir_ui_view'):
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view'):
        with self.assertLogs('dosyt.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
