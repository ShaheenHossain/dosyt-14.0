...
from dosyt.http import Controller, dispatch_rpc, request, route
from dosyt.service import wsgi_server
from dosyt.fields import Date, Datetime
from dosyt.tools import lazy, ustr
from dosyt.tools.misc import frozendict
...
class DosytMarshaller(xmlrpc.client.Marshaller):
    ...
    # Historically, dosyt is sending binary as base64 string.
