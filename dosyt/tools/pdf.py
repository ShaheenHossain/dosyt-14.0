...
class DosytPdfFileWriter(PdfFileWriter):
    ...
    def embed_dosyt_attachment(self, attachment, subtype=None):
        assert attachment, "embed_dosyt_attachment cannot be called without attachment."
