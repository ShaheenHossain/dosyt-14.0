...
from dosyt.modules.module import get_module_root, MANIFEST_NAMES
from dosyt.service.db import _create_empty_database, DatabaseExists
...
class Start(Command):
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            dosyt.tools.config['init']['base'] = True
