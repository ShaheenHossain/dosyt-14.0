...
from dosyt.tools import (config, existing_tables, ignore,
                        lazy_classproperty, lazy_property, sql, OrderedSet)
from dosyt.tools.lru import LRU

_logger = logging.getLogger(__name__)
_schema = logging.getLogger('dosyt.schema')
...
class Registry(Mapping):
    ...
    def __new__(cls, db_name):
        ...
        with cls._lock:
            try:
                ...
                # dosyt.service.wsgi_server.application
        ...
        with cls._lock:
            with dosyt.api.Environment.manage():
                ...
                try:
                    ...
                    try:
                        dosyt.modules.load_modules(registry._db, force_demo, status, update_module)
                    except Exception:
                        dosyt.modules.reset_modules_state(db_name)
                        raise
                except Exception:
    ...
    def init(self, db_name):
        ...
        self._init = True
        self._assertion_report = dosyt.tests.runner.DosytTestResult()
        ...
        self._db = dosyt.sql_db.db_connect(db_name)
        ...
        with closing(self.cursor()) as cr:
            self.has_unaccent = dosyt.modules.db.has_unaccent(cr)
    ...
    def init_models(self, cr, model_names, context, install=True):
        ...
        env = dosyt.api.Environment(cr, SUPERUSER_ID, context)
