...
2.  Modify your current pull request, or make a new pull request on
    [dosyt/dosyt](/dosyt/dosyt), adding a new file `<github-login>.md` under the
...
2.  Modify your current pull request, or make a new pull request on
    [dosyt/dosyt](/dosyt/dosyt), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is Dosyt, the file would be
    `doc/cla/corporate/dosyt.md`. The file should contain:
...
`cla-submission` `at` `dosyt.com`.  In that case someone from the Dosyt team will
make the pull request on your behalf.

* Printable Dosyt CCLA v1.0 https://www.dosyt.com/files/legal/Dosyt-CCLA-v1.0.pdf
* Printable Dosyt ICLA v1.0 https://www.dosyt.com/files/legal/Dosyt-ICLA-v1.0.pdf
