...
class Users(models.Model):
    ...
    dosytbot_state = fields.Selection(
        [
    ...
    dosytbot_failed = fields.Boolean(readonly=True)
    ...
    def __init__(self, pool, cr):
        ...
        type(self).SELF_READABLE_FIELDS = type(self).SELF_READABLE_FIELDS + ['dosytbot_state']
        return init_res
