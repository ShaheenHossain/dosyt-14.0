...
from dosyt.tests.common import SavepointCase, new_test_user
...
class TestAccessRights(SavepointCase):
    ...
    @classmethod
    @mute_logger('dosyt.tests', 'dosyt.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    @mute_logger('dosyt.addons.base.models.ir_rule')
