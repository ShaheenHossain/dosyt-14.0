...
class TestWebsiteResetViews(dosyt.tests.HttpCase):
    ...
    @mute_logger('dosyt.addons.http_routing.models.ir_http')
    ...
    # @mute_logger('dosyt.addons.http_routing.models.ir_http', 'dosyt.addons.website.models.ir_ui_view')
