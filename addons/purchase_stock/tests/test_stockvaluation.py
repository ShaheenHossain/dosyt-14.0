...
from dosyt.tests import Form
from dosyt.tests.common import TransactionCase, tagged
from dosyt.addons.account.tests.common import AccountTestInvoicingCommon
from dosyt.tools import DEFAULT_SERVER_DATETIME_FORMAT
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('dosyt.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('dosyt.fields.Date.context_today', _today),
            patch('dosyt.fields.Datetime.now', _now),
        ]
