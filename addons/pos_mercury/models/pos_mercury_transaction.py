...
from dosyt import models, api, service
from dosyt.tools.translate import _
from dosyt.exceptions import UserError
from dosyt.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "Dosyt " + service.common.exp_version()['server_version']
