...
from dosyt.addons.portal.controllers.portal import CustomerPortal, pager as portal_pager
from dosyt.tools import groupby as groupbyelem

from dosyt.osv.expression import OR
