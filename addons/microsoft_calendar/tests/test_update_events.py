...
from dosyt.addons.microsoft_calendar.models.res_users import User
from dosyt.addons.microsoft_calendar.utils.event_id_storage import combine_ids
from dosyt.addons.microsoft_calendar.tests.common import TestCommon, mock_get_token, _modified_date_in_the_future, patch_api
...
class TestUpdateEvents(TestCommon):
    ...
    def test_update_simple_event_from_dosyt(self, mock_patch):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_simple_event_from_dosyt_attendee_calendar(self, mock_patch):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_one_event_of_recurrence_from_dosyt(self, mock_patch):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_event_of_recurrence_from_dosyt(self, mock_patch):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_event_of_recurrence_from_dosyt_with_overlap(self, mock_patch):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_one_event_of_recurrence_from_dosyt_attendee_calendar(self, mock_patch):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_one_and_future_events_of_recurrence_from_dosyt(
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_and_future_events_of_recurrence_from_dosyt(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_one_and_future_events_of_recurrence_from_dosyt_with_overlap(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
        Update a Dosyt event start date and future events from a recurrence from the organizer calendar,
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_one_and_future_events_of_recurrence_from_dosyt_attendee_calendar(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_name_of_all_events_of_recurrence_from_dosyt(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_start_of_all_events_of_recurrence_from_dosyt(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
    ...
    @patch.object(MicrosoftCalendarService, 'insert')
    @patch.object(MicrosoftCalendarService, 'patch')
    def test_update_all_events_of_recurrence_from_dosyt_attendee_calendar(
        self, mock_patch, mock_insert, mock_delete
    ):
        """
