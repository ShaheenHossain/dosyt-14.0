...
from dosyt.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import ValuationReconciliationTestCommon
from dosyt.tests import common, Form
from dosyt.exceptions import UserError
from dosyt.tools import mute_logger, float_compare
from dosyt.addons.stock_account.tests.test_stockvaluation import _create_accounting_data
...
class TestSaleMrpFlow(ValuationReconciliationTestCommon):
    ...
    @mute_logger('dosyt.tests.common.onchange')
