...
class StripeTest(StripeCommon):
    ...
    def run(self, result=None):
        with mute_logger('dosyt.addons.payment.models.payment_acquirer', 'dosyt.addons.payment_stripe.models.payment'):
    ...
    @patch('dosyt.addons.payment_stripe.models.payment.request')
    @patch('dosyt.addons.payment_stripe.models.payment.datetime')
    ...
    def test_handle_checkout_webhook_no_dosyt_tx(self):
        stripe_object = stripe_mocks.checkout_session_object
