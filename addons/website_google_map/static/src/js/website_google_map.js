function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('dosyt-google-map'), {
        zoom: 1,
    ...
    if (dosyt_partner_data){ /* dosyt_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < dosyt_partner_data.counter; i++) {
            set_marker(dosyt_partner_data.partners[i]);
        }
