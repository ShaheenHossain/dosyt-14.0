...
from dosyt.api import Environment
from dosyt.tools import DEFAULT_SERVER_DATE_FORMAT
from datetime import date, timedelta

from dosyt.tests import Form, tagged, new_test_user
from dosyt.addons.point_of_sale.tests.test_frontend import TestPointOfSaleHttpCommon
