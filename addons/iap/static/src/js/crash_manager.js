dosyt.define('iap.CrashManager', function (require) {
"use strict";
...
CrashManager.include({
    ...
    _getButtonMessage: function (isTrial){
        var isEnterprise = _.last(dosyt.session_info.server_version_info) === 'e';
    ...
    rpc_error: function (error) {
        var self = this;
        if (error.data.name === "dosyt.addons.iap.tools.iap_tools.InsufficientCreditError") {
            ...
            ajax.jsonRpc('/web/dataset/call_kw', 'call', {
                ...
                var content = $(QWeb.render('iap.redirect_to_dosyt_credit', {
                        data: error_data,
                    }));
                if (error_data.body) {
