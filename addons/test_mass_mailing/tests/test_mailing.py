...
from dosyt.addons.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
from dosyt.addons.test_mass_mailing.tests.common import TestMassMailCommon
...
class TestMassMailing(TestMassMailCommon):
    ...
    def test_mailing_gateway_update(self):
        ...
        self.assertMailTraces(
            ...
            mailing, recipients,
            mail_links_info=[[
                ('url0', 'https://www.dosyt.tz/my/%s' % record.name, True, {}),
                ...
                ('url7', 'mailto:test@dosyt.com', False, {}),
        ...
        # simulate a click
        self.gateway_mail_click(mailing, recipients[0], 'https://www.dosyt.be')
