...
<span>Website0: <a id="url0" href="https://www.dosyt.tz/my/${object.name}">https://www.dosyt.tz/my/${object.name}</a></span>
<span>Website1: <a id="url1" href="https://www.dosyt.be">https://www.dosyt.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test@dosyt.com">test@dosyt.com</a></span>
