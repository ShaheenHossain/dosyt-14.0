...
from dosyt import _, api, fields, models, tools
from dosyt.addons.bus.models.bus_presence import AWAY_TIMER
from dosyt.addons.bus.models.bus_presence import DISCONNECTION_TIMER
...
class Partner(models.Model):
    ...
    def _compute_im_status(self):
        ...
        dosytbot = self.env['res.partner'].browse(dosytbot_id)
        if dosytbot in self:
            dosytbot.im_status = 'bot'
