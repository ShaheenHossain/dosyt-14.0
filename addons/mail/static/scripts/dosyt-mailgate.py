...
# dosyt-mailgate
#
# This program will read an email from stdin and forward it to dosyt. Configure
# a pipe alias in your mail server to use it, postfix uses a syntax that looks
# like:
#
# email@address: "|/home/dosyt/src/dosyt-mail.py"
#
# while exim uses a syntax that looks like:
#
# *: |/home/dosyt/src/dosyt-mail.py
#
...
def main():
    ...
    op.add_option("-d", "--database", dest="database", help="Dosyt database name (default: %default)", default='dosyt')
