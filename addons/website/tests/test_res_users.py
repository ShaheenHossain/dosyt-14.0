...
from dosyt.tests.common import TransactionCase, new_test_user
from dosyt.exceptions import ValidationError
from dosyt.service.model import check
...
class TestWebsiteResUsers(TransactionCase):
    ...
    def test_same_website_message(self):
        ...
        with self.assertRaises(ValidationError), mute_logger('dosyt.sql_db'):
