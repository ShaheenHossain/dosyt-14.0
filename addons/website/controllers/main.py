...
from dosyt import http, models, fields, _
from dosyt.http import request
from dosyt.tools import OrderedSet
from dosyt.addons.http_routing.models.ir_http import slug, slugify, _guess_mimetype
from dosyt.addons.web.controllers.main import Binary
from dosyt.addons.portal.controllers.portal import pager as portal_pager
from dosyt.addons.portal.controllers.web import Home
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': dosyt.service.common.exp_version()
        }
