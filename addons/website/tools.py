...
import dosyt
from dosyt.tools.misc import DotDict
...
def MockRequest(
    ...
    with contextlib.ExitStack() as s:
        dosyt.http._request_stack.push(request)
        s.callback(dosyt.http._request_stack.pop)
        s.enter_context(patch('dosyt.http.root.get_db_router', router))
