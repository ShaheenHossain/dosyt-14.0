...
import dosyt
from dosyt import api, models
from dosyt import registry, SUPERUSER_ID
from dosyt.http import request
from dosyt.tools.safe_eval import safe_eval
from dosyt.osv.expression import FALSE_DOMAIN
from dosyt.addons.http_routing.models.ir_http import ModelConverter, _guess_mimetype
...
class Http(models.AbstractModel):
    ...
    def _dispatch(cls):
        """
        In case of rerouting for translate (e.g. when visiting dosyt.com/fr_BE/),
