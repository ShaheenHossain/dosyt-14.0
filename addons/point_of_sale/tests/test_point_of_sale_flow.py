...
import dosyt
from dosyt import fields, tools
from dosyt.tools import float_compare, mute_logger, test_reports
from dosyt.tests.common import Form
from dosyt.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('dosyt.addons.point_of_sale.models.pos_order'):
