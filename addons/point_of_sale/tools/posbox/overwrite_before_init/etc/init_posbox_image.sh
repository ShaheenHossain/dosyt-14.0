...
wget 'https://nightly.dosyt.com/master/iotbox/eftdvs' -P /usr/local/bin/
chmod +x /usr/local/bin/eftdvs
wget 'https://nightly.dosyt.com/master/iotbox/eftapi.so' -P /usr/lib/

groupadd usbusers
usermod -a -G usbusers pi
usermod -a -G lp pi
usermod -a -G input lightdm
mkdir -v /var/log/dosyt
chown pi:pi /var/log/dosyt
chown pi:pi -R /home/pi/dosyt/
...
echo "* * * * * rm /var/run/dosyt/sessions/*" | crontab -
...
echo "addons/hw_drivers/iot_devices/" > /home/pi/dosyt/.git/info/exclude
