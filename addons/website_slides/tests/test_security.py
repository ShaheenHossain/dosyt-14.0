...
from dosyt.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('dosyt.models', 'dosyt.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('dosyt.models.unlink', 'dosyt.addons.base.models.ir_rule', 'dosyt.addons.base.models.ir_model')
