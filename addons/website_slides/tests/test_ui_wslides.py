...
from dosyt import tests
from dosyt.fields import Datetime
from dosyt.modules.module import get_module_resource
from dosyt.addons.base.tests.common import HttpCaseWithUserDemo, HttpCaseWithUserPortal
...
class TestUi(TestUICommon):
    ...
    def test_course_member_employee(self):
        ...
        self.browser_js(
            '/slides',
            'dosyt.__DEBUG__.services["web_tour.tour"].run("course_member")',
            'dosyt.__DEBUG__.services["web_tour.tour"].tours.course_member.ready',
    ...
    def test_full_screen_edition_website_publisher(self):
        ...
        self.browser_js(
            '/slides',
            'dosyt.__DEBUG__.services["web_tour.tour"].run("full_screen_web_editor")',
            'dosyt.__DEBUG__.services["web_tour.tour"].tours.full_screen_web_editor.ready',
            login=user_demo.login)
    ...
    def test_course_reviews_elearning_officer(self):
        ...
        self.browser_js(
            '/slides',
            'dosyt.__DEBUG__.services["web_tour.tour"].run("course_reviews")',
            'dosyt.__DEBUG__.services["web_tour.tour"].tours.course_reviews.ready',
            login=user_demo.login)
...
class TestUiYoutube(HttpCaseWithUserDemo):
    ...
    def test_course_member_yt_employee(self):
        ...
        self.browser_js(
            '/slides',
            'dosyt.__DEBUG__.services["web_tour.tour"].run("course_member_youtube")',
            'dosyt.__DEBUG__.services["web_tour.tour"].tours.course_member_youtube.ready',
            login=user_demo.login)
    ...
    def test_course_publisher_elearning_manager(self):
        ...
        self.browser_js(
            '/slides',
            'dosyt.__DEBUG__.services["web_tour.tour"].run("course_publisher")',
            'dosyt.__DEBUG__.services["web_tour.tour"].tours.course_publisher.ready',
            login=user_demo.login)
