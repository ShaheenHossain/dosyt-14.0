...
import dosyt.addons.iap.tools.iap_tools
from dosyt import http, tools
from dosyt.http import request
from dosyt.tools.misc import formatLang
...
class MailClientExtensionController(http.Controller):
    ...
    def auth_access_token(self, auth_code, **kw):
        ...
        scope = 'dosyt.plugin.' + auth_message.get('scope', '')
    ...
    def _get_auth_code_data(self, auth_code):
        ...
        signature = dosyt.tools.misc.hmac(request.env(su=True), 'mail_client_extension', data).encode()
    ...
    def _generate_auth_code(self, scope, name):
        ...
        signature = dosyt.tools.misc.hmac(request.env(su=True), 'mail_client_extension', auth_message).encode()
    ...
    def _iap_enrich(self, domain):
        ...
        #except dosyt.addons.iap.models.iap.InsufficientCreditError as ice:
        except dosyt.addons.iap.tools.iap_tools.InsufficientCreditError:
