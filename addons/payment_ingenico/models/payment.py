...
from dosyt.addons.payment_ingenico.controllers.main import OgoneController
from dosyt.addons.payment_ingenico.data import ogone
from dosyt.http import request
from dosyt.tools import DEFAULT_SERVER_DATE_FORMAT, ustr
from dosyt.tools.float_utils import float_compare, float_repr, float_round
...
class PaymentAcquirerOgone(models.Model):
    ...
    def _ogone_generate_shasign(self, inout, values):
        ...
        :param string inout: 'in' (dosyt contacting ogone) or 'out' (ogone
                             contacting dosyt). In this last case only some
