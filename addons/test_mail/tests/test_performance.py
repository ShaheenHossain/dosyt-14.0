...
class TestMailAPIPerformance(BaseMailPerformance):
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('dosyt.models.unlink', 'dosyt.tests', 'dosyt.addons.mail.models.mail_mail')
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('dosyt.tests', 'dosyt.addons.mail.models.mail_mail', 'dosyt.models.unlink')
