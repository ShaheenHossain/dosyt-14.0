...
from dosyt.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from dosyt.addons.test_mail.models.test_mail_models import MailTestSimple
from dosyt.addons.test_mail.tests.common import TestMailCommon, TestRecipients
from dosyt.api import call_kw
from dosyt.exceptions import AccessError
from dosyt.tests import tagged
from dosyt.tools import mute_logger, formataddr
...
class TestMessagePost(TestMailCommon, TestRecipients):
    ...
    def test_post_inactive_follower(self):
        # In some case dosytbot is follower of a record.
        # Even if it shouldn't be the case, we want to be sure that dosytbot is not notified
        (self.user_employee | self.user_admin).write({'notification_type': 'inbox'})
    ...
    @mute_logger('dosyt.addons.mail.models.mail_mail', 'dosyt.tests')
    ...
    @mute_logger('dosyt.addons.mail.models.mail_mail', 'dosyt.addons.mail.models.mail_thread')
