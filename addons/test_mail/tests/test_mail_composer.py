...
from dosyt.addons.test_mail.models.test_mail_models import MailTestTicket
from dosyt.addons.test_mail.tests.common import TestMailCommon, TestRecipients
from dosyt.tests import tagged
from dosyt.tests.common import users, Form
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('dosyt.tests', 'dosyt.addons.mail.models.mail_mail')
...
class TestComposerResultsComment(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('dosyt.models.unlink', 'dosyt.addons.mail.models.mail_mail')
