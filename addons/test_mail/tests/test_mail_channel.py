...
from dosyt.tests import tagged, Form
...
from dosyt.exceptions import AccessError, ValidationError, UserError
...
class TestChannelAccessRights(TestMailCommon):
    ...
    @mute_logger('dosyt.addons.base.models.ir_model', 'dosyt.models')
    ...
    @mute_logger('dosyt.addons.base.models.ir_model', 'dosyt.models', 'dosyt.models.unlink')
...
class TestChannelFeatures(TestMailCommon):
    ...
    @mute_logger('dosyt.addons.mail.models.mail_mail', 'dosyt.models.unlink')
    ...
    @mute_logger('dosyt.models.unlink')
...
class TestChannelModeration(TestMailCommon):
    ...
    @mute_logger('dosyt.addons.mail.models.mail_channel', 'dosyt.models.unlink')
