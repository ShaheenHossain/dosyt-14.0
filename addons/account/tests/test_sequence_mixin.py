# -*- coding: utf-8 -*-
from dosyt.addons.account.tests.common import AccountTestInvoicingCommon
from dosyt.tests import tagged
from dosyt.tests.common import Form, TransactionCase
from dosyt import fields, api, SUPERUSER_ID
...
class TestSequenceMixin(AccountTestInvoicingCommon):
    ...
    def test_journal_sequence(self):
        ...
        with Form(copy2) as move_form:  # It is editable in the form
            with mute_logger('dosyt.tests.common.onchange'):
...
class TestSequenceMixinConcurrency(TransactionCase):
    ...
    def test_sequence_concurency(self):
        ...
        with self.assertRaises(psycopg2.OperationalError), mute_logger('dosyt.sql_db'):
            move.action_post()
