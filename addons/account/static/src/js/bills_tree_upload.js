dosyt.define('account.upload.bill.mixin', function (require) {
"use strict";
...
dosyt.define('account.bills.tree', function (require) {
"use strict";
    var core = require('web.core');
...
dosyt.define('account.dashboard.kanban', function (require) {
"use strict";
    var core = require('web.core');
