...
from dosyt import models, api, _, fields
from dosyt.osv import expression
from dosyt.release import version
from dosyt.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from dosyt.tools.misc import formatLang, format_date as dosyt_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                act = {
                    ...
                    'date': dosyt_format_date(self.env, activity.get('date_deadline'))
                }
