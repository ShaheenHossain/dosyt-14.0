...
from dosyt.exceptions import RedirectWarning, UserError, ValidationError, AccessError
from dosyt.tools import float_compare, date_utils, email_split, email_re, float_is_zero
from dosyt.tools.misc import formatLang, format_date, get_lang
...
class AccountMove(models.Model):
    ...
    def _get_invoice_reference_dosyt_invoice(self):
    ...
    def _get_invoice_reference_dosyt_partner(self):
        """ This computes the reference based on the Dosyt format.
