...
from dosyt.addons.base.models.res_bank import sanitize_account_number
from dosyt.tools import remove_accents
import logging
import re
import warnings
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('dosyt', 'Dosyt'),('euro', 'European')], default=_default_invoice_reference_model, help="You can choose different models for each type of reference. The default one is the Dosyt reference.")
