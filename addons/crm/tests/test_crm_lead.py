...
from dosyt.addons.crm.models.crm_lead import PARTNER_FIELDS_TO_SYNC, PARTNER_ADDRESS_FIELDS_TO_SYNC
from dosyt.addons.crm.tests.common import TestCrmCommon, INCOMING_EMAIL
from dosyt.addons.phone_validation.tools.phone_validation import phone_format
from dosyt.exceptions import UserError
from dosyt.tests.common import Form, users
