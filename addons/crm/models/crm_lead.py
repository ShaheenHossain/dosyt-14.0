...
from dosyt import api, fields, models, tools, SUPERUSER_ID
from dosyt.osv import expression
from dosyt.tools.translate import _
from dosyt.tools import email_re, email_split
...
PLS_COMPUTE_BATCH_STEP = 50000  # dosyt.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
