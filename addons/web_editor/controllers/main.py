...
from dosyt import http, tools, _, SUPERUSER_ID
from dosyt.addons.http_routing.models.ir_http import slug
from dosyt.exceptions import UserError
from dosyt.modules.module import get_module_path, get_resource_path
from dosyt.tools.misc import file_open

from ..models.ir_attachment import SUPPORTED_IMAGE_MIMETYPES

logger = logging.getLogger(__name__)
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.dosyt.com'
