...
Also, adds methods to convert values back to Dosyt models.
"""
...
import dosyt.modules

from dosyt import api, models, fields
from dosyt.tools import ustr, posix_to_ldml, pycompat
from dosyt.tools import html_escape as escape
from dosyt.tools.misc import get_lang, babel_locale_parse
from dosyt.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = dosyt.modules.get_module_resource(
