dosyt.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in dosyt.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" dosyt domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in dosyt.
 */
...
/**
 * Let users choose a document, including uploading a new document in dosyt.
 */
