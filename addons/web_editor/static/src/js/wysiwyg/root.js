dosyt.define('web_editor.wysiwyg.root', function (require) {
'use strict';
...
var WysiwygRoot = Widget.extend({
    ...
    willStart: function () {
        ...
        return this._super().then(function () {
            ...
            if (!assetsLoaded) {
                var Wysiwyg = dosyt.__DEBUG__.services['web_editor.wysiwyg'];
    ...
    _getWysiwygContructor: function () {
        return dosyt.__DEBUG__.services['web_editor.wysiwyg'];
    }
});
...
dosyt.define('web_editor.wysiwyg.default_options', function (require) {
'use strict';
...
dosyt.define('web_editor.browser_extensions', function (require) {
'use strict';
