dosyt.define('web_editor.rte.summernote', function (require) {
'use strict';
...
// outside the iframe.
const topBus = window.top.dosyt.__DEBUG__.services['web.core'].bus;
...
renderer.createPalette = function ($container, options) {
    ...
    const parent = dosyt.__DEBUG__.services['root.widget'];
...
// Translation for dosyt
$.summernote.lang.dosyt = {
    font: {
      bold: _t('Bold'),
      italic: _t('Italic'),
