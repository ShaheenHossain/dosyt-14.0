...
from dosyt import api, models, fields, tools, _
from dosyt.tools import DEFAULT_SERVER_DATE_FORMAT, float_repr, str2bool
from dosyt.tests.common import Form
from dosyt.exceptions import RedirectWarning, UserError
...
class AccountEdiFormat(models.Model):
    ...
    def _prepare_invoice_report(self, pdf_writer, edi_document):
        ...
        pdf_writer.embed_dosyt_attachment(edi_document.attachment_id, subtype='text/xml')
    ...
    def _import_facturx(self, tree, invoice):
        ...
        with Form(invoice.with_context(default_move_type=default_move_type)) as invoice_form:
            ...
            # Fallback for old invoices from dosyt where the InvoiceCurrencyCode was not present
            else:
