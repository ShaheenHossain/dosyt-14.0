...
Dosyt is an <a href="https://www.dosyt.com/page/e-commerce">Open Source eCommerce</a>
...
Dosyt's unique *'edit inline'* and building blocks approach makes product pages
...
Dosyt's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Dosyt's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Dosyt marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Dosyt proposes
...
SEO tools are ready to use, with no configuration required. Dosyt suggests
...
Create new landing pages easily with the Dosyt inline editing feature. Send
...
Benefit from the power of Dosyt, in your online store: a powerfull tax engine,
...
Everything is integrated with Dosyt. No pain, real time.
