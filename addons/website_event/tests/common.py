...
from dosyt.fields import Datetime as FieldsDatetime, Date as FieldsDate
from dosyt.tests.common import SavepointCase
...
class EventDtPatcher(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.event_dt = patch(
            'dosyt.addons.event.models.event_event.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.wevent_dt = patch(
            'dosyt.addons.website_event.models.event_event.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.wevent_main_dt = patch(
            'dosyt.addons.website_event.controllers.main.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.event_date = patch(
            'dosyt.addons.event.models.event_event.fields.Date',
            wraps=FieldsDate
        )
        cls.wevent_main_date = patch(
            'dosyt.addons.website_event.controllers.main.fields.Date',
            wraps=FieldsDate
        )
