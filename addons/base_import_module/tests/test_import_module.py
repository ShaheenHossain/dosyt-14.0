...
from dosyt.addons import __path__ as __addons_path__
from dosyt.tools import mute_logger
from dosyt.tests.common import TransactionCase, HttpCase
...
class TestImportModule(TransactionCase):
    ...
    def test_import_zip_invalid_manifest(self):
        ...
        with mute_logger("dosyt.addons.base_import_module.models.ir_module"):
    ...
    def test_import_zip_ignore_unexpected_data_extension(self):
        ...
        with self.assertLogs('dosyt.addons.base_import_module.models.ir_module') as log_catcher:
            self.import_zipfile(files)
