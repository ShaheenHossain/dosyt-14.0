...
from dosyt import api, models, fields, _
from dosyt.tests.common import Form
from dosyt.exceptions import UserError
from dosyt.addons.l10n_it_edi.tools.remove_signature import remove_signature
from dosyt.osv.expression import OR, AND
