...
import dosyt.addons.web.controllers.main
from dosyt import http, _
from dosyt.addons.auth_totp.models.res_users import TRUSTED_DEVICE_SCOPE
...
class Home(dosyt.addons.web.controllers.main.Home):
    @http.route(
        '/web/login/totp',
