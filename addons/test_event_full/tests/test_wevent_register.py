...
from dosyt.addons.test_event_full.tests.common import TestWEventCommon
from dosyt.tests.common import HOST
...
class TestWEventRegister(TestWEventCommon):
    ...
    def test_register(self):
        self.browser_js(
            '/event',
            'dosyt.__DEBUG__.services["web_tour.tour"].run("wevent_register")',
            'dosyt.__DEBUG__.services["web_tour.tour"].tours.wevent_register.ready',
            login=None
        )
