...
from dosyt.addons.crm.models import crm_stage
from dosyt.exceptions import ValidationError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap-services.dosyt.com'
...
class CRMRevealRule(models.Model):
    ...
    # Methods responsible for format response data in to valid dosyt lead data
