...
from dosyt import models, _, _lt
from dosyt.exceptions import UserError
from dosyt.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
            ...
            if state == 'awaiting_outcome':
                ...
                if invoice._is_commercial_partner_pa():
                    to_return[invoice] = {'error': _(
                        ...
                        ' Should this also fail, the System will notify Dosyt of the failed delivery,'
