...
from dosyt.tools.pdf import DosytPdfFileReader, DosytPdfFileWriter
from dosyt.osv import expression
from dosyt.tools import html_escape
from dosyt.exceptions import RedirectWarning
...
class AccountEdiFormat(models.Model):
    ...
    def _prepare_invoice_report(self, pdf_writer, edi_document):
        ...
        if self._is_embedding_to_invoice_pdf_needed() and edi_document.attachment_id:
            pdf_writer.embed_dosyt_attachment(edi_document.attachment_id)
