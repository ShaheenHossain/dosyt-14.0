...
from dosyt import SUPERUSER_ID, _, api, fields, models
from dosyt.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
from dosyt.exceptions import UserError
from dosyt.osv import expression
from dosyt.tools import DEFAULT_SERVER_DATETIME_FORMAT, format_datetime
from dosyt.tools.float_utils import float_compare, float_is_zero, float_round
from dosyt.tools.misc import format_date
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, Dosyt will automatically pre-fill the detailed "
