...
from dosyt import SUPERUSER_ID, _, api, fields, models, registry
from dosyt.exceptions import UserError
from dosyt.osv import expression
from dosyt.tools import float_compare, float_is_zero, html_escape
from dosyt.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product):
        ...
        :type product: :class:`~dosyt.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~dosyt.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
