dosyt.define('partner_autocomplete.tests', function (require) {
    "use strict";
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "dosyt.com/logo.png" ? "dosytbase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            testUtils.fields.editInput($input, "dosyt")
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "dosyt.com/logo.png"
                    || route === "data:image/png;base64,dosytbase64") { // land here as it is not valid base64 content
            ...
            await testUtils.fields.editInput($input, "dosyt");
            ...
            assert.strictEqual(form.$("input.o_field_widget").val(), "dosyt.com", "website value should have been updated to \"dosyt.com\"");
            ...
            await testUtils.nextTick();
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing dosyt letters again");
