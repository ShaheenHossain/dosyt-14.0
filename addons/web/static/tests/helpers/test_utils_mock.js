dosyt.define('web.test_utils_mock', function (require) {
"use strict";
...
function _mockGlobalObjects(params) {
    ...
    if ('config' in params) {
        ...
        if ('debug' in params.config) {
            dosyt.debug = params.config.debug;
        }
    }
 ...
 *   used to generate mock answers for every kind of routes supported by dosyt
