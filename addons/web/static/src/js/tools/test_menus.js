(function (exports) {
    ...
    let isEnterprise = dosyt.session_info.server_version_info[5] === 'e';

    function createWebClientHooks() {
        var AbstractController = dosyt.__DEBUG__.services['web.AbstractController'];
        var DiscussWidget = dosyt.__DEBUG__.services['mail/static/src/widgets/discuss/discuss.js'];
        var WebClient = dosyt.__DEBUG__.services["web.WebClient"];
