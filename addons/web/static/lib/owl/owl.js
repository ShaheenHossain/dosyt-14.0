...
See https://github.com/dosyt/owl/blob/master/doc/reference/config.md#mode for more information.`);
            }
        },
    });
    ...
    class Component {
         ...
         *  - it can be patched (useful in dosyt ecosystem)
  ...
  `;
    ...
    __info__.url = 'https://github.com/dosyt/owl';
