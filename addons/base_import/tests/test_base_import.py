...
from dosyt.tests.common import TransactionCase, can_import
from dosyt.modules.module import get_module_resource
from dosyt.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('dosyt.addons.base_import.models.base_import')
