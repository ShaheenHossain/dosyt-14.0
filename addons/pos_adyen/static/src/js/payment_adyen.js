dosyt.define('pos_adyen.payment', function (require) {
"use strict";
...
var PaymentAdyen = PaymentInterface.extend({
    ...
    _handle_dosyt_connection_failure: function (data) {
        // handle timeout
    ...
    _call_adyen: function (data, operation) {
        return rpc.query({
            ...
            timeout: 10000,
            shadow: true,
        }).catch(this._handle_dosyt_connection_failure.bind(this));
    },
    ...
    _poll_for_response: function (resolve, reject) {
        ...
        return rpc.query({
            ...
            if (self.remaining_polls != 0) {
                ...
                return self._handle_dosyt_connection_failure(data);
            }
