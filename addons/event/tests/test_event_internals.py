...
class TestEventData(TestEventCommon):
    ...
    def setUpClass(cls):
        ...
        cls.patcher = patch('dosyt.addons.event.models.event_event.fields.Datetime', wraps=FieldsDatetime)
...
class TestEventTicketData(TestEventCommon):
    ...
    def setUp(self):
        ...
        self.ticket_date_patcher = patch('dosyt.addons.event.models.event_ticket.fields.Date', wraps=FieldsDate)
